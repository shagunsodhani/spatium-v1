            ...
            chart: {
                ...
                events: {
                    load: function () {
                        ...
                        $.getJSON("nations.json", function(json) {
                        ...
                        // console.log(file_series);
                        var i = 0;
                        var len = file_series.data.length;
                        setInterval(function () {
                            if (i>len-1)
                            {
                                i = i%len;
                            }
                            add_point(file_series.xData[i], file_series.yData[i]);
                            i++;
                        }, 1000);
                    }
                }
...
function data_static(type) {
    $('#container').highcharts({
        chart: {
            zoomType: 'x'
        },
        title: {
            text: 'Frequency of occurrence of '+type+' from 2001 to 2014'
        },
        subtitle: {
...
function box_plot(){
    $('.lat').highcharts({
     ...
     $('.lng').highcharts({
        ...
        title: {
            text: '<p><p>Box Plot for Longitude'
        },
